...
RSpec.describe 'Arrays' do
  ...
  it 'test 4' do
    ...
    # In the line below, add the element 
    # "Brazil" to the end of the world_cup array
    world_cup << "Brazil"
    expect(world_cup.last).to eq("Brazil")

    # Use a different method to add the element "Japan" 
  ...
  it 'test 5' do
    world_cup = ["Germany", "Mexico", "Iceland", "Portugal"]
    # Call a method on the world_cup variable to remove 
    # and return
  ...
  it 'test 6' do
    ...
    # Call a method on the karaoke variable to 
    # ask whether "Toxic"
    # is an element or not
    toxic_in_array = karaoke.include?('Toxic')
    expect(toxic_in_array).to eq(false)

    # Now call a method on the karaoke 
    # variable to ask whether "Dancing Queen"
    # is an element or not
  ...
  it 'test 7' do
    ...
    # Call a method on the band variable 
    # to add the element "Vocals"
  ...
  it 'test 8' do
    ...
    # Call a method to remove and 
    # return the first element from the garden array
  ...
  it 'test 9' do
    ...
    # Call a method on the teams variable to get 
